...
public class JdbcConnectDBTest {
    String driver = "com.mysql.jdbcBase.Driver";
    String url = "jdbcBase:mysql://localhost:3306/test?characterEncoding=UTF-8";
    ...
    // 测试：DriverManager.getConnection("jdbcBase:mysql://localhost:3306/test?user=root&password=123456")
    @Test
    public void testConnection3() throws ClassNotFoundException, SQLException {
        Class.forName(driver);
        Connection connection = DriverManager.getConnection("jdbcBase:mysql://localhost:3306/test?user=root&password=123456");
        connection.close();
    }
